...
namespace VSOExp
{
    internal static class SafeNativeMethods
    {
         ...
         * Dbghelp.UnDecorateSymbolName("?$is_member_pointer@VCAudioSignal@CGameAudio@@", UnDecorated, UnDecorated.Capacity, Dbghelp.UnDecorateFlags.UNDNAME_COMPLETE); 
         * 
         */
        [DllImport( "dbghelp.dll", SetLastError = true, PreserveSig = true, CharSet = CharSet.Unicode )]
        internal static extern int UnDecorateSymbolName(
            [In] [MarshalAs( UnmanagedType.LPWStr )] string DecoratedName,
